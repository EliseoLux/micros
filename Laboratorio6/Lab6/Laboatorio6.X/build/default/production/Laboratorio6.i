...
configEnable:
    ...
    bsf ((INTCON) and 07Fh), 5 ;encender interrupcion timerCero
    bsf ((INTCON) and 07Fh), 6 ;encender interrupcion timerUno
...
atribuidor: ;Atribuye valor decimal a partir de hexadecimal
    movf nibble,w
    call tabla7seg
    movwf display
